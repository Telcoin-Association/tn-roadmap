...
function ClosedPullRequestsFeed() {
  ...
  return (
    <article className="flex flex-1 flex-col gap-4 rounded-[16px] border-[0.4px] border-[#C9CFED99] bg-[#172552] p-5 shadow-soft backdrop-blur transition-colors duration-300 hover:border-primary/40 hover:shadow-glow">
            ...
            {pagePrs.map((pr) => (
              <li key={pr.number}>
                <a
                  ...
                  className="block rounded-xl border border-white/10 bg-white/5 p-3 text-fg backdrop-blur transition-colors hover:border-primary/40"
                >
  ...
  return (
    <section aria-labelledby="security-heading" className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-[1.2fr_1fr]">
        <article className="flex h-full flex-col rounded-[16px] border-[0.4px] border-[#C9CFED99] bg-[#172552] p-6 shadow-soft backdrop-blur transition-colors duration-300 hover:border-primary/40 hover:shadow-glow">
